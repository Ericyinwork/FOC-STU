...
void setPhaseVoltage(float Uq, float Ud, float angle_el)
{
	...
	__HAL_TIM_SET_COMPARE(&htim1,TIM_CHANNEL_1,Ta*TIM_1_8_PERIOD_CLOCKS);      //输出PWM,配置占空比
	__HAL_TIM_SET_COMPARE(&htim1,TIM_CHANNEL_2,Tb*TIM_1_8_PERIOD_CLOCKS);
	__HAL_TIM_SET_COMPARE(&htim1,TIM_CHANNEL_3,Tc*TIM_1_8_PERIOD_CLOCKS);
